...
DROP TABLE IF EXISTS excluded_product CASCADE;
...
CREATE TABLE cart_wise_coupon (
                                  id UUID PRIMARY KEY REFERENCES coupon(id) ON DELETE CASCADE,
