...
class DiscountCalculatorTest {
    ...
    void calculatePercentageDiscount_correct() {
        BigDecimal result = DiscountCalculator.calculatePercentageDiscount(
    ...
    void calculateDiscountWithCap_appliesCap() {
        BigDecimal result = DiscountCalculator.calculateDiscountWithCap(
    ...
    void calculateFinalPrice_neverBelowZero() {
        BigDecimal result = DiscountCalculator.calculateFinalPrice(
                BigDecimal.valueOf(50),
                BigDecimal.valueOf(100)
        );
